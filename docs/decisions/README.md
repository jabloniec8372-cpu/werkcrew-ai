...
| [0010 — Frozen M1 Lifecycle Contract v1](0010-frozen-m1-lifecycle-v1.md) | USTALONE | durable operation ledger, exact idempotency, explicit correlation, activity DORMANT/wake i append-only evidence/history |
