...
| [0010 — Decision Semantics Freeze](0010-decision-semantics-freeze.md) | USTALONE | rozdzielenie prawdy, władzy i wykonania; FORCED, recovery, sprzeciw oraz NO_DECEPTION |
| [0011 — Frozen M1 Lifecycle Contract v1](0011-frozen-m1-lifecycle-v1.md) | USTALONE | durable operation ledger, exact idempotency, explicit correlation, activity DORMANT/wake i append-only evidence/history |
