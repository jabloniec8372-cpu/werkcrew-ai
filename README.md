...
Ta granica persystencji nie jest jeszcze podłączona do Worker App, API/UI ani runtime Strands/Bedrock. Nie istnieje też dispatcher outboxa. End-to-end MobileWC pozostaje następnym krokiem domknięcia M2; obecny checkpoint nie oznacza zamknięcia produktu/runtime M2. Szczegółowy zakres i ograniczenia zapisuje [M2 Durable Persistence Checkpoint](docs/mobilewc/M2_PERSISTENCE_CHECKPOINT.md).
